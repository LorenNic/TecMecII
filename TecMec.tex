...
\include{chapters/chapter_1} %Introduzione e lavorazioni su lamiera
\part{Sitenrizzazione}
\include{chapters/chapter_3} %Sinterizzazione
\part{Asportazione di truciolo}
\include{chapters/chapter_2} %Asportazione di truciolo
\include{chapters/chapter_4} %Ottimizzazione lavorazioni
\include{chapters/chapter_5} %Lavorazioni abrasive
\part{Lavorazioni non convenzionali}
\include{chapters/chapter_6} %Lavorazioni non convenzionali
\part{Tecniche di giunzione}
\include{chapters/chapter_7} %Tecniche di giunzione
