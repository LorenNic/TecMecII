...
\begin{figure}
\centering
\subfloat[][\emph{Schema lavorazione per elettroerosione}\label{fig:ElettroErosione}]
{\includegraphics[width = 0.4\textwidth]{ElettroErosione}}\quad
\subfloat[][\emph{Schema del funzionamento elettroerosione a filo}\label{fig:ElettroErosFilo}]
{\includegraphics[width = 0.3\textwidth]{ElettroErosFilo}}
...
\includegraphics[width = 0.3\textwidth]{TuboCatodico}
...
\begin{figure}
\centering
\subfloat[][\emph{Schema generale del taglio laser}\label{fig:LaserCut}]
{\includegraphics[width = 0.4\textwidth]{LaserCut}}\quad
\subfloat[][\emph{Taglio laser con laser ad ossigeno}\label{fig:OxLaserCut}]
{\includegraphics[width = 0.4\textwidth]{OxLaserCut}}
...
In più il laser è estremamente preciso in quanto il cono in cui vengono sparati i fotoni è molto piccolo.
...
\begin{figure}
\subfloat[][\emph{Effettivo taglio al plasma su macchina \ac{CNC}}\label{fig:TaglPlasma}]
{\includegraphics[width = 0.3\textwidth]{TaglPlasma}}\:
\subfloat[][\emph{Taglio/Saldatura ossiacetilenica}\label{fig:TaglOssi}]
{\includegraphics[width = 0.3\textwidth]{TaglOssi}}\:
\subfloat[][\emph{Lavorazione per taglio ad acqua}\label{fig:TaglAcqua}]
{\includegraphics[width = 0.3\textwidth]{TaglAcqua}}
