...
figura \todo{\\Aggiungi riferimento figura}.

\begin{figure}
\missingfigure{Aggiungere schema taglio ortogonale realistico}
\caption{Taglio ortogonale realistico}
...
\subsection{Truciolo continuo} Si verifica per velocità abbastanza basse. Come dice il nome il truciolo forma un continuo filamento di materiale.
...
\subsection{Truciolo continuo ondulato}
...
\subsection{Truciolo continuo a dente di sega}
...
\begin{figure}
\missingfigure{Aggiungere esempi di rompi-truciolo}
...
superiore \todo{\\Inserire equazioni angolo di spoglia superiore}.
...
di \textbf{avanzamento}. Inoltre si introduce 
la \textbf{profondità di passaggio}.
...
\begin{figure}
\missingfigure{Grafico inclinazione tagliente}
\caption{Visualizzazione dei parametri nella tornitura}
\label{fig:ParamTornitura}
\end{figure}
